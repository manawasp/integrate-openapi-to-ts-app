...
/* tslint:disable */
/* eslint-disable */
import type { ListRecipesComments } from '../models/ListRecipesComments';
import type { PatchRecipeCommentPayload } from '../models/PatchRecipeCommentPayload';
import type { PostRecipeCommentPayload } from '../models/PostRecipeCommentPayload';
...
export class RecipesCommentsService {
     ...
     * @returns ListRecipesComments Successful Response
     * @throws ApiError
     */
    public recipesCommentsList({
        ...
        l?: number,
        p?: number,
    }): CancelablePromise<ListRecipesComments> {
    ...
    public recipesCommentsCreate({
        ...
        recipeId: number,
        requestBody: PostRecipeCommentPayload,
    ...
    public recipesCommentsUpdate({
        ...
        recipeId: number,
        commentId: number,
        requestBody: PatchRecipeCommentPayload,
    }): CancelablePromise<RecipeComment> {
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/recipes/{recipe_id}/comments/{comment_id}',
